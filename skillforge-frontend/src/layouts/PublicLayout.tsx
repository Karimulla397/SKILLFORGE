...
const PublicLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent">
      <header className="sticky top-0 glass-dark backdrop-blur-sm border-b border-slate-700/20 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="text-xl font-bold nav-link-dark">
            SkillForge
          </Link>
          <nav className="flex gap-4 text-sm font-medium nav-link-muted">
