  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold nav-link-dark">Hey {user?.name?.split(' ')[0]},</h1>
        <p className="muted">Track your active courses, resume where you left off, and discover new skills to forge.</p>
      </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold nav-link-dark">Continue learning</h2>
        </div>
        {enrollments.length === 0 ? (
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold nav-link-dark">Recommended for you</h2>
        </div>
        {loadingCatalog ? (
          <LoadingScreen />
        ) : (
