    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-3">
          <h2 className="text-lg font-semibold nav-link-dark">Lecture playlist</h2>
          <div className="space-y-2 max-h-[420px] overflow-y-auto pr-2">
            {videos.map((video) => (
              ...
              >
                ...
                <p className="text-xs text-slate-500 mt-1">{video.sectionTitle}</p>
              </button>
            ))}
          </div>
          ...
          {allQuizzes.length > 0 && (
            <div className="pt-4 border-t">
              <h2 className="text-lg font-semibold nav-link-dark mb-6">Quizzes</h2>
              {!selectedQuiz ? (
                <div className="space-y-2 max-h-[420px] overflow-y-auto pr-2">
                      {allQuizzes.map((quiz) => (
                        <button
                          ...
                          className="w-full text-left flex flex-col gap-2 p-3 rounded-xl border border-amber-200 glass-panel hover:shadow-md transition"
                        >
                ...
                <div className="border border-amber-200 rounded-xl p-4 glass-panel space-y-4">
                  ...
                  {!quizSubmitted ? (
                    <div className="space-y-4 max-h-[400px] overflow-y-auto">
                      {selectedQuiz.questions?.map((question, qIdx) => (
                        <div
                          key={qIdx}
                          className="glass-panel rounded-lg p-3 border border-amber-100 space-y-2"
                        >
