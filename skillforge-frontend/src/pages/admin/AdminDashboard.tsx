  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <h1 className="text-3xl font-bold nav-link-dark">SkillForge Control Center</h1>
        <p className="text-slate-300">Monitor catalog health, role-based activity, and storage.</p>
      </div>
