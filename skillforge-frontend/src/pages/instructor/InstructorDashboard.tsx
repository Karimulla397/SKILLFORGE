...
const InstructorDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold nav-link-dark">Instructor HQ</h1>
        <p className="muted">Design, upload, and launch curriculum effortlessly.</p>
      </div>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold nav-link-dark">Your catalog</h2>
        {courses.length ? (
