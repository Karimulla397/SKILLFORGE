...
import { addQuiz, addSection, createCourse, deleteQuiz, deleteSection, getInstructorCourses, uploadCourseThumbnail, uploadCourseNote, generateQuiz } from '../../api/instructor'
    ...
    <div className="grid lg:grid-cols-2 gap-8">
      <div className="glass-panel p-6 space-y-4">
        ...
        >
          ...
          >
            {createCourseMutation.isPending ? 'Creating...' : 'Upload course'}
          </button>
        </form>
      </div>
      <div className="glass-panel p-6 space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 max-h-[360px] overflow-y-auto pr-2">
              {selectedCourse.sections?.map((section) => (
                <div key={section.id} className="border border-slate-200 rounded-lg p-3 section-card">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="flex gap-1 section-actions">
                      <button
                        type="button"
                        onClick={() =>
                        ...
                        className="text-xs font-semibold btn-expand"
                      >
